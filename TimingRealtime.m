...
for loopIndex = 1:10
    ...
    switch locationMode
        ...
        case 2 %Spatial Filtering
            ...
            if P == 1
                ...
                if loopIndex == 1
                    ...
                    ResultSC = ResultSC+Speed*round(elapsedTime*29.97);%trainingframerate = 29.97 ==> speed relative to trainingDB
                end
        ...
        case 3 %Particle Filtering
            ...
            %motion model
            SpeedMot = Speed*round(elapsedTime*29.97);%trainingframerate = 29.97 ==> speed relative to trainingDB
            particles = round(particles + SpeedMot + SpeedStDev*round(elapsedTime*29.97)*randn(size(particles)));
